...
const arrLit = [1, 2, 3, 4, 5]; //whether we use literal or constructor array is a typeof object
...
console.log(funcLit, typeof funcLit); //it's stil an object, a certain type of object
console.log(funcLit(5));

const funcObj = new Function("x", "return x*x");
console.log(funcObj.constructor);
